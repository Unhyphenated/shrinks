  ...
  return (
    <div className="max-w-md mx-auto animate-in fade-in slide-in-from-bottom-8 duration-500 pt-12 pb-20">
      <div className="bg-white border-2 border-zinc-900 p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] relative">
        <div className="absolute top-0 right-0 p-2 bg-black text-white text-[10px] font-mono font-bold uppercase">RECOVERY</div>
        ...
        <div className="mb-8 text-center">
          ...
          <h2 className="text-2xl font-bold tracking-tight text-zinc-900 uppercase">Reset Password</h2>
