...
export function EmailTemplateView() {
  const handleCopyHtml = () => {
    ...
    const emailHtml =
      document.querySelector(".email-template-container")?.innerHTML || "";
  ...
  return (
    <div className="max-w-2xl mx-auto animate-in fade-in slide-in-from-bottom-8 duration-500 pt-8 pb-20">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h2 className="text-3xl font-bold text-zinc-900 tracking-tighter uppercase">
            Template Preview
          </h2>
          <p className="text-zinc-500 text-sm font-mono">
            Subject: Reset your Shrinks Password
          </p>
        </div>
        <button
      ...
      <div className="bg-zinc-100 p-8 rounded-lg border border-zinc-200">
        <div className="email-template-container bg-white max-w-lg mx-auto border border-zinc-200 shadow-sm">
          ...
          {/* Email Body */}
          <div className="p-8">
            <h1 className="text-xl font-bold text-zinc-900 mb-4 font-sans">
            ...
            <p className="text-zinc-600 text-sm leading-relaxed mb-6 font-sans">
              ...
              <br />
              <br />
              We received a request to reset the password for your Shrinks
              account associated with this email address. If you didn't make
            ...
            <p className="text-zinc-600 text-sm leading-relaxed mb-6 font-sans">
              This link will expire in 60 minutes. If you need assistance,
